...
if __name__ == "__main__":
    ...
    parser.add_argument("--pred-file", required=False, type=str, default='/vision/hwjiang/vq2d/output/ego4d_vq2d/vq2d_all_transformer2_anchor_dinov2_inference/default-arch_aug-clip_anchor_focal-w10_2heads_dropout0.2_positive0.3_inference/inference_cache_val_results.json.gz')
